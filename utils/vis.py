# TODO: Fix this file from https://github.com/ShadeAlsha/LTR-weight-balancing/blob/master/utils/eval_funcs.py
...
def plot_per_epoch_accuracy(result_dict):
    train_acc = result_dict['acc_train']
    test_acc = result_dict['acc_test'] 
